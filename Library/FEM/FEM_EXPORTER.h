...
template <class EX_SPACE, class MEM_SPACE, std::size_t BIN_SIZE> void Export_Storage(py::module &m) {
    ...
    py::class_<BASE_STORAGE<VECTOR<int, 2>, VECTOR<double, 2>, VECTOR<double, 2>, VECTOR<double, 2>, double, double>>(m, "V2iV2dV2dV2dSdSdStorage").def(py::init());
    py::class_<BASE_STORAGE<VECTOR<int, 2>, VECTOR<double, 3>, VECTOR<double, 3>, VECTOR<double, 3>, double, double>>(m, "V2iV3dV3dV3dSdSdStorage").def(py::init());
...
void Export_FEM(py::module& m) {
    ...
    m.def("Test_CCD", &Test_CCD<double, 3>);
}
